...
function M.setup(colors, config)
    ...
    return {
        ...
        MiniStatuslineModeNormal = { fg = theme.ui.bg, bg = theme.syn.fun },
        MiniStatuslineModeInsert = { fg = theme.ui.bg, bg = theme.diag.ok },
        MiniStatuslineModeVisual = { fg = theme.ui.bg, bg = theme.syn.keyword },
        MiniStatuslineModeReplace = { fg = theme.ui.bg, bg = theme.syn.constant },
        MiniStatuslineModeCommand = { fg = theme.ui.bg, bg = theme.syn.operator },
        MiniStatuslineModeOther = { fg = theme.ui.bg, bg = theme.syn.type },
