...
function M.setup(colors, config)
	...
	return {
		...
		MiniFilesBorderModified = {
			...
			bg = config.transparent and theme.ui.none or theme.ui.float.bg,
		},
		...
		MiniPickBorderBusy = { fg = theme.diag.warning, bg = config.transparent and theme.ui.none or theme.ui.float.bg },
		MiniPickBorderText = { fg = theme.ui.special, bg = config.transparent and theme.ui.none or theme.ui.float.bg },
		...
		MiniPickPrompt = { fg = theme.ui.fg, bg = config.transparent and theme.ui.none or theme.ui.float.bg },
		...
		MiniStatuslineFilename = {
			...
			bg = config.transparent and theme.ui.none or theme.statusline.bg,
		},
		...
		-- mini.tabline
		MiniTablineCurrent = { fg = theme.ui.fg, bg = theme.ui.bg, bold = true },
		MiniTablineFill = { bg = theme.ui.bg_p1 },
		MiniTablineHidden = { fg = theme.ui.fg_dim, bg = theme.ui.bg_p1 },
		MiniTablineModifiedCurrent = { fg = theme.vcs.changed, bg = theme.ui.bg, bold = true },
		...
		MiniTablineTabpagesection = { fg = theme.ui.bg, bg = theme.statusline.normal, bold = true },
		MiniTablineTrunc = { fg = theme.ui.fg_dim, bg = theme.ui.bg_p1 },
